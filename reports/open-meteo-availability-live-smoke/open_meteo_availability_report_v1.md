...
| historical_forecast_best_match | historical_forecast | best_match | seamless_historical_forecast | 1 | 1 | 1 | 100.00 | OPEN_METEO_HISTORICAL_FORECAST_AUDIT_ONLY | requires_run_metadata_before_causal_use | EXPERIMENT_ONLY |
| historical_weather_era5 | historical_weather | era5 | reanalysis_not_forecast | 1 | 1 | 1 | 100.00 | OPEN_METEO_BLOCKED_BY_CAUSALITY_METADATA | diagnostic_only_reanalysis | EXPERIMENT_ONLY |
| previous_runs_gfs_temperature | previous_runs | gfs_seamless | fixed_lead_forecast | 1 | 1 | 1 | 100.00 | OPEN_METEO_PREVIOUS_RUNS_READY_FOR_LEAD_AUDIT | fixed_lead_skill_audit_only | EXPERIMENT_ONLY |
| single_runs_ecmwf_ifs_hres | single_runs | ecmwf_ifs025 | forecast_snapshot | 1 | 0 | 0 | 0.00 | OPEN_METEO_BLOCKED_BY_AVAILABILITY | no_successful_probe | EXPERIMENT_ONLY |
...
| historical_forecast_best_match | historical_forecast | best_match | seamless_historical_forecast | 1 | 1 | 1 | False | False | 100.00 | EXPERIMENT_ONLY |
| historical_weather_era5 | historical_weather | era5 | reanalysis_not_forecast | 1 | 1 | 1 | False | False | 100.00 | EXPERIMENT_ONLY |
| previous_runs_gfs_temperature | previous_runs | gfs_seamless | fixed_lead_forecast | 1 | 1 | 1 | False | False | 100.00 | EXPERIMENT_ONLY |
| single_runs_ecmwf_ifs_hres | single_runs | ecmwf_ifs025 | forecast_snapshot | 1 | 0 | 0 | True | True | 0.00 | EXPERIMENT_ONLY |
